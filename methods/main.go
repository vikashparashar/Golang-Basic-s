...
// Interface And Methods In Golang
...
type Employee interface {
	PrintName(name string) // This Is A Method Not A function
	PrintSalary(basic int, tax int) int // this is another method not a function
}
